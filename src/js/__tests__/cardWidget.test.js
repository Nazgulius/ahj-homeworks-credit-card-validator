...
test("widget should add valid class in visa", () => {
  ...
  expect(document.querySelector(".visa").classList.contains("valid")).toEqual(
    true,
  );
});
...
test("widget should add valid class in MasterCard", () => {
  ...
  expect(document.querySelector(".master").classList.contains("valid")).toEqual(
    true,
  );
});
...
test("widget should add valid class in American Express", () => {
  ...
  expect(document.querySelector(".amex").classList.contains("valid")).toEqual(
    true,
  );
});
...
test("widget should add valid class in JCB", () => {
  ...
  expect(document.querySelector(".jcb").classList.contains("valid")).toEqual(
    true,
  );
});
...
test("widget should add valid class in Discover", () => {
  ...
  expect(
    document.querySelector(".discover").classList.contains("valid"),
  ).toEqual(true);
});
...
test("widget should add valid class in Diners Club", () => {
  ...
  expect(
    document.querySelector(".diners_club").classList.contains("valid"),
  ).toEqual(true);
});
...
test("widget should add valid class in Mir", () => {
  ...
  expect(document.querySelector(".mir").classList.contains("valid")).toEqual(
    true,
  );
});
...
test("widget should add invalid class in visa", () => {
  ...
  expect(document.querySelector(".visa").classList.contains("invalid")).toEqual(
    true,
  );
});
